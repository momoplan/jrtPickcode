	...
	<div class="buy_content1" id="daiGouDIV">
		...
		<div class="buy_con">
			...
			<div class="buy_con_list">
				...
				彩票发行中心对排列三进行<a href="/rules/betProtocol.html" title="限号管理" target="_bank"><span class="buy_blue">限号管理</span></a>
				，我已阅读并同意网站<a href="/rules/betProtocol.html">《<span class="buy_blue">排列三投注风险须知</span>》</a>
				</div>
		</div>
		<div class="buy_tzh">
