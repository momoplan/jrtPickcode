...
function zuLiuHeSelectBall(sender) {
    ...
    function CheckFull_zu6() {
        ...
        var p = invest * 2;   
        $("#zu6Select").html(invest + decodeURI(EncodeUtf8("注，")) + p.toFixed() + decodeURI(EncodeUtf8("元。")));
        if(GetBallSelectedNum_zu6() < 1) $("#btnZu6").attr('isdisabled', 'true');
        else   $("#btnZu6").attr('isdisabled', 'false');
    }
    ...
    function ClearSelect() {
        ...
        $("#zu6Select").html(decodeURI(EncodeUtf8("0注， 0元。")));
    }
