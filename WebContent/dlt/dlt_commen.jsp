...
<div class="redselect">
	<div class="redselect_left">
	  <div class="dantuo_left1">前区至少选择5个</div>
	</div>
	  ...
	  <div class="redselect_mid_ball">
		...
		<div class="redselect_mid_ball">
				<ul>
                    ...
                    <li class="ball_num" id="td_r_34" onclick="SelectBall('r','34');">34</li>
                    <li class="ball_num" id="td_r_35" onclick="SelectBall('r','35');">35</li>
                </ul>
		</div>
	</div>
	<div class="redselect_right">
		<div class="red_sel"><select id="qianQuBall"  onChange="controllQianQuBall()">
		...
		<div class="red_select"><a href="javascript:qianQuRand()">机选前区</a></div>
		<div class="red_reset"><a href="javascript:dlt_clearRedSelect()">重选</a></div>
	</div>
  </div>
<div class="bluedanma">
	<div class="bluedanma_left">
		<div class="dantuo_left">后区至少选择2个</div>
	</div>
	...
	<div class="redselect_right">
		<div class="red_sel"><select id="houQuBall"  onChange="controllHouQuBall()" >
		...
		<div class="red_select"><a href="javascript:houQuRand()">机选后区</a></div>
		<div class="red_reset"><a href="javascript:dlt_clearBlueSelect()">重选</a></div>
	</div>
</div>
  <div class="ball_money">【您选择了 <span class="red_text" id="lab_2_Selected">0注,0元 </span>】</div>
  <div class="add_basket1">
  	<span class="add_btton1"><img id="dlt_btn_2_Add" onclick="return btn_2_AddClick();"   src="/images/add_btn.gif"/></span>
